...
public class MenuTestDrive {
    public static void main(String args[]) {
        MenuComponent pancakeHouseMenu =
                new Menu("БЛИННОЕ МЕНЮ", "Завтрак");
        MenuComponent dinerMenu =
                new Menu("МЕНЮ ОБЕДА", "Обед");
        MenuComponent cafeMenu =
                new Menu("МЕНЮ КАФЕ", "Ужин");
        MenuComponent dessertMenu =
                new Menu("ДЕСЕРТНОЕ МЕНЮ", "Десерт");
        ...
        dinerMenu.add(new MenuItem("Паста", "Лапша с помидорами", true, 3.89));
        ...
        pancakeHouseMenu.add(new MenuItem("Панкейки от K&B", "Блины с яйцом и тостами", true, 2.99));
